...
export class MainMenuSupport {
  ...
  constructor(page: Page) {
    ...
    this.getSupport = page.locator(
      "//span[normalize-space(text())='Get Support']"
    );
    this.trainingAndEducation = page.locator(
      "//span[normalize-space(text())='Training & Education']"
    );
    this.downloads = page.locator(
      "//span[normalize-space(text())='Downloads']"
    );
    this.renewalCenter = page.locator(
      "//span[normalize-space(text())='Renewals Center']"
    );
    this.supportResources = page.locator(
      "//span[normalize-space(text())='Support Resources']"
    );
    this.community = page.locator(
      "//span[normalize-space(text())='Community']"
    );
  }
